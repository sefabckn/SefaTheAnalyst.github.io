...
### [Capstone Project](https://github.com/sefabckn/CapstoneProject)
**Technologies**: JavaScript  
**Description**: A comprehensive project showcasing advanced JavaScript functionalities and application development.

### [Fancy Challenge](https://github.com/sefabckn/fancychallenge)
**Technologies**: JavaScript  
**Description**: An innovative challenge project focusing on dynamic user interactions and responsive design.

### [Spotify Teamwork](https://github.com/sefabckn/m3d5-Spotify-TeamWork)
**Technologies**: HTML, CSS, JavaScript  
**Description**: Collaborative project replicating Spotify's interface, emphasizing teamwork and frontend development skills.

### [Netflix Router Homework](https://github.com/sefabckn/Strive-School-m4d8-Homework-Netflix-Router)
**Technologies**: JavaScript  
**Description**: Homework assignment implementing routing in a Netflix-like application, enhancing understanding of client-side routing.
